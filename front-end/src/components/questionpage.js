  	...
  	return(
  		<div>
 	        <Navbar className="red darken-4" brand="Elbi Quiz" right>
	          ...
	          <div class="container">
	            <br></br>
	            <h1 class="header center red-text">Quesition #</h1>
	            <div class="row center">
	          	  <h5 class="header col s12 light">Get question from database</h5>
	            </div>
	          </div>
	          <div class="row center">
	          	<a href="#" id="download-button" class="btn-large waves-effect waves-light red">Choice 1</a>
	           	<a href="#" id="download-button" class="btn-large waves-effect waves-light red">Choice 2</a>
	           	<a href="#" id="download-button" class="btn-large waves-effect waves-light red">Choice 3</a>
	           	<a href="#" id="download-button" class="btn-large waves-effect waves-light red">Choice 4</a>
	          </div> 
	     	</div>
       ...
       <div class="container">
        ...
        <br></br>
			...
			<div class="footer-copyright">
				<div class="container"> Mercy and Compassion please </div>	
			</div>
			</footer>     
		</div>
	);
